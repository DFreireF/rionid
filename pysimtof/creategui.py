...
class CreateGUI():
    ...
    def __init__(self, exp_data, simulated_data_dict, ref_ion, nuclei_names, ndivs, filename = 'Spectrum'):
    ...
    def create_canvas(self, ndivs):
        ...
        self.canvas_main = TCanvas('canvas', 'Frequency Histograms', 800, 800)
